...
import com.leon.bilihub.ui.adapters.searchResult.SearchResultPgcAdapter;
 ...
 * @Desc 搜索结果-影视
 */
public class SearchResultPgcFragment extends BaseLazyFragment<FragmentResultCinephileBinding> {
    ...
    public SearchResultPgcFragment(String keyword) {
    ...
    protected void initView() {
        ...
        loader = new PaginationLoader<>(binding.content, new SearchResultPgcAdapter(context));
